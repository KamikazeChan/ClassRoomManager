...
namespace ClassRoom.UserManager
{
    ...
    /// </summary>
    public partial class UcImageCropper : System.Windows.Window
    {
            ...
            try
            {
                ...
                using (System.Drawing.Bitmap source = new System.Drawing.Bitmap(ImgUrl))
                {
                    ...
                    using (System.Drawing.Bitmap target = new System.Drawing.Bitmap((int)rubberBand.Width, (int)rubberBand.Height))
                    {
                        ...
                        tempFileName = @"C:\Users\Administrator\Desktop\ImageCropper (1)\MyPicture\";
                        //if (fixedTempIdx > 2)
                        //    fixedTempIdx = 0;
                        //else
                        //    ++fixedTempIdx;
